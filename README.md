...
### Docker
* docker build -t insurance:latest .
* docker run -p 8081:8080 insurance

### Postman
Import the following json file on Postman to test API endpoints
InsurancePolicy.postman_collection.json

### Database
Please create new PostgreSQL database named insurance before running application (see application.properties file)
